...
module.exports = (sequelize, DataTypes) => {
  ...
  Doctor.init({
    name: {
      ...
      allowNull : false,
      validate : {
        allowNull : {msg : `SIP cannot be empty`},
    ...
    specialist: {
      ...
      allowNull : false,
      validate : {
        allowNull : {msg : `Specialization cannot be empty`},
    ...
    exp: {
      ...
      allowNull : false,
      validate : {
        allowNull : {msg : `Experience cannot be empty`},
    ...
    hospital: {
      ...
      allowNull : false,
      validate : {
        allowNull : {msg : `Hospital cannot be empty`},
    ...
    price: {
      ...
      allowNull : false,
      validate : {
        allowNull : {msg : `Price cannot be empty`},
